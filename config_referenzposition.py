...
for frame in camera.capture_continuous(rawCapture, format = "bgr", use_video_port=True):
    ...
    if key == ord("q"):
        ...
        parser.set('roi_referenz', 'centerArea1', str(center1))
        parser.set('roi_referenz', 'centerArea2', str(center2))
        parser.set('roi_referenz', 'centerArea3', str(center3))
        parser.set('roi_referenz', 'centerArea4', str(center4))
